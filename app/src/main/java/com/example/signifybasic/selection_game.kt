...
import com.example.signifybasic.databinding.ActivitySelectionGameBinding
...
class selection_game : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val navController = findNavController(R.id.nav_host_fragment_activity_selection_game)
